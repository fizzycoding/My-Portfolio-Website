...
const ContactPage = () => {
  ...
  return (
    <div>
      <section
        className="overflow-hidden m:py-20 relative z-1 max-sm:mb-5 flex flex-col items-center"
        ref={ref}
      >
        <motion.h2
        ...
        <div className="w-full flex-col gap-4 justify-center items-center px-3 flex mt-5 sm:mt-16 max-w-xl">
          {[
